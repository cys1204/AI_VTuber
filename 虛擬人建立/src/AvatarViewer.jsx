...
const AvatarViewer = () => {
    ...
    const [inputText, setInputText] = useState("現在你可以選聲音，而且我閉嘴時絕對安靜！");
...
const styles = {
    body: { position: 'relative', width: '100vw', height: '100vh', background: 'radial-gradient(circle at center, #3a3a3a 0%, #1a1a1a 100%)', overflow: 'hidden', fontFamily: '"Microsoft JhengHei", sans-serif', color: 'white' },
